...
for i in range(0,num_iter):
    ...
    convnet_acc=convnet_acc+score[1]
    ...
    convnet_bin_acc=convnet_bin_acc+score[1]
    ...
    convnet_fidelity=convnet_fidelity+fidelity_value

#Final results
print("FINAL RESULTS******************************")
print("MLP accuracy:", str(mlp_acc/num_iter))
print("CONVNET accuracy:", str(convnet_acc/num_iter))
print("MLP_BIN accuracy:", str(mlp_bin_acc/num_iter))
print("CONVNET_BIN accuracy:", str(convnet_bin_acc/num_iter))
print("FIDELITY mlp vs mlp_bin:" + str(mlp_fidelity/num_iter))
print("FIDELITY convnet vs convnet_bin:" + str(convnet_fidelity/num_iter))
